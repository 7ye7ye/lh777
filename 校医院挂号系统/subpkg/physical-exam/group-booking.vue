  ...
  <view class="group-bg">
    ...
    <view class="section card">
      ...
      <view class="form-item">
        ...
        <picker mode="date" :value="formData.expectDate" :start="minDateStr" :end="maxDateStr" @change="onDateChange">
          <view class="date-picker">
            <text :class="{ placeholder: !formData.expectDate }">
              {{ displayExpectDate || '请选择期望体检日期' }}
            </text>
...
// 格式化显示期望日期
const displayExpectDate = computed(() => {
  if (!formData.value.expectDate) return ''
  const date = new Date(formData.value.expectDate)
