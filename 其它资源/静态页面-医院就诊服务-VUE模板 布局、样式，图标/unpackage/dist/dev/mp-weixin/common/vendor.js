...
function populateParameters(result) {
  ...
  var parameters = {
    appId: "__UNI__630930A",
    appName: "静态页面-医院就诊服务-VUE模板 布局、样式，图标",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"静态页面-医院就诊服务-VUE模板 布局、样式，图标","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!***************************************************************************!*\
  !*** D:/yeyeye/课程/专业实训Ⅲ/项目代码/lh777/静态页面-医院就诊服务-VUE模板 布局、样式，图标/pages.json ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 39 */
/*!*************************************************************************************************************!*\
  !*** D:/yeyeye/课程/专业实训Ⅲ/项目代码/lh777/静态页面-医院就诊服务-VUE模板 布局、样式，图标/pages/hospital_services/hospital_services.js ***!
  \*************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  methods: {
    /**
    * hospital_services_4_4处理函数
    * 数据绑定  data-index="{{index}}" 
    * 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
    */
    hospital_services_4_4_click: function hospital_services_4_4_click(event) {},
    /**
    * hospital_services_6_6处理函数
    * 数据绑定  data-index="{{index}}" 
    * 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
    */
    hospital_services_6_6_click: function hospital_services_6_6_click(event) {},
    /**
    * hospital_services_29_29处理函数
    * 数据绑定  data-index="{{index}}" 
    * 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
    */
    hospital_services_29_29_click: function hospital_services_29_29_click(event) {},
    /**
    * hospital_services_32_32处理函数
    * 数据绑定  data-index="{{index}}" 
    * 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
    */
    hospital_services_32_32_click: function hospital_services_32_32_click(event) {},
    /**
    * hospital_services_35_35处理函数
    * 数据绑定  data-index="{{index}}" 
    * 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
    */
    hospital_services_35_35_click: function hospital_services_35_35_click(event) {},
    /**
    * hospital_services_38_38处理函数
    * 数据绑定  data-index="{{index}}" 
    * 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
    */
    hospital_services_38_38_click: function hospital_services_38_38_click(event) {},
    /**
    * hospital_services_41_41处理函数
    * 数据绑定  data-index="{{index}}" 
    * 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
    */
    hospital_services_41_41_click: function hospital_services_41_41_click(event) {},
    /**
    * hospital_services_44_44处理函数
    * 数据绑定  data-index="{{index}}" 
    * 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
    */
    hospital_services_44_44_click: function hospital_services_44_44_click(event) {},
    /**
    * hospital_services_48_48处理函数
    * 数据绑定  data-index="{{index}}" 
    * 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
    */
    hospital_services_48_48_click: function hospital_services_48_48_click(event) {},
    /**
    * hospital_services_51_51处理函数
    * 数据绑定  data-index="{{index}}" 
    * 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
    */
    hospital_services_51_51_click: function hospital_services_51_51_click(event) {},
    /**
    * hospital_services_54_54处理函数
    * 数据绑定  data-index="{{index}}" 
    * 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
    */
    hospital_services_54_54_click: function hospital_services_54_54_click(event) {},
    /**
    * hospital_services_58_58处理函数
    * 数据绑定  data-index="{{index}}" 
    * 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
    */
    hospital_services_58_58_click: function hospital_services_58_58_click(event) {},
    /**
    * hospital_services_59_59处理函数
    * 数据绑定  data-index="{{index}}" 
    * 数据取值  var index = e.currentTarget.dataset.index; var cata = this.list_cata_list[index];
    */
    hospital_services_59_59_click: function hospital_services_59_59_click(event) {},
    //刷新数据
