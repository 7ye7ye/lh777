...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        // filterChainDefinitionMap.put("/sys/common/download/**",
        // "anon");//文件下载不限制token
        ...
        // filterChainDefinitionMap.put("/test/jeecgDemo/rabbitMqClientTest/**",
        // "anon"); //MQ测试
        ...
        filterChainDefinitionMap.put("/applet/registration/**", "anon"); // exclude registration for load testing
    ...
    // update-begin---author:chenrui ---date:20240126
    // for：【QQYUN-7932】AI助手------------
    ...
    public CookieRememberMeManager rememberMeManager() {
        ...
        // 移除 SameSite 设置，因为当前 Shiro 版本不支持 SameSiteOptions 枚举
        // cookie.setSameSite(Cookie.SameSiteOptions.valueOf("Strict")); // 这行会报错
    ...
    public IRedisManager redisManager() {
        ...
        // sentinel cluster redis（【issues/5569】shiro集成 redis 不支持 sentinel 方式部署的redis集群
        // #5569）
